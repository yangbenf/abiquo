...
import com.abiquo.tarantino.plugins.esxi.ExtendedAppUtil;
import com.abiquo.tarantino.plugins.esxi.VirtualMachineException;
import com.abiquo.tarantino.plugins.esxi.VmwareMachineDisk;
import com.abiquo.tarantino.plugins.esxi.utils.EsxiUtils.EsxiUtilsException;
import com.abiquo.tarantino.plugins.esxi.utils.EsxiUtils.VMTasks;
 ...
 */
public class VmwareMachineUtils// extends EsxiUtils
{
    /** The logger object. */
    ...
    public VmwareMachineUtils(EsxiUtils utils)
    {
        this.utils = utils;
    }
     ...
     * @throws Exception
     */
    private void configureNetwork(List<VirtualNIC> vnicList) throws VirtualFactoryException
    {
     ...
     */
    private void deconfigureNetwork(List<VirtualNIC> vnicList) throws VirtualFactoryException
    {
